...
public:
    ...
    const    char* getStateDesc(State state);
    ...
    void streamIsReadyRead(bool bUnsupportCodec=false, AudioStreamBasicDescription* dstFormat=NULL);
...
private:
    ...
    bool m_localUnsupportCodecRunning;
    bool m_unsupportCodec;
