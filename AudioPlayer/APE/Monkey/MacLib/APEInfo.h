...
#define GET_IO(APE_INFO) ((CStdLibFileIO *) (APE_INFO)->GetInfo(APE_INFO_IO_SOURCE))
...
public:
    ...
    CAPEInfo(int * pErrorCode, APE_MONKEY::CStdLibFileIO * pIO, CAPETag * pTag = NULL);
    virtual ~CAPEInfo();
...
private:
    ...
    CSmartPtr<APE_MONKEY::CStdLibFileIO> m_spIO;
